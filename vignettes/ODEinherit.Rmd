...
For a single mother–daughter cell pair, the pipeline should complete in under an hour.
...
For this example, we use a first-order Mat$\'e$rn kernel.  
...
─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────
 ! package     * version    date (UTC) lib source
   ...
   ODEinherit  * 1.0.0      2025-08-12 [1] local
